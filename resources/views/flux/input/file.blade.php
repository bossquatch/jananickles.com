...
>
    ...
    <flux:button as="div" class="cursor-pointer mt-4 !bg-indigo-600 !font-semibold !text-white !shadow-sm hover:!bg-indigo-500" :$size aria-hidden="true">
        <?php if ($multiple) : ?>
            {!! __('Choose files') !!}
        <?php else : ?>
            {!! __('Choose file') !!}
...
{{--    <div x-ref="name" class="cursor-default select-none truncate whitespace-nowrap text-sm text-zinc-800 dark:text-zinc-700 font-medium" aria-hidden="true">--}}
{{--        {!! __('No file chosen') !!}--}}
{{--    </div>--}}
</div>
